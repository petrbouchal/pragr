...
prg_endpoints <- tibble::tribble(~name, ~type, ~description, ~endpoint, ~url,
                         "orto", "tile", "", "",
                         "https://mpp.praha.eu/arcgis/rest/services/MAP/letecke_snimky_posledni_snimkovani_cache/ImageServer",
                         "dsm", "tile", "", "",
                         ...
                         "https://mpp.praha.eu/arcgis/rest/services/MAP/letecke_snimky_posledni_snimkovani_cache/ImageServer",
                         "orto_mimoveg", "tile", "", "",
                         "https://mpp.praha.eu/arcgis/rest/services/MAP/mimovegetacni_snimkovani_cache/ImageServer",
                         "orto_mimoveg", "image", "", "",
                         "https://mpp.praha.eu/arcgis/rest/services/MAP/mimovegetacni_snimkovani_cache/ImageServer",
                         "orto_2003", "image", "", "",
