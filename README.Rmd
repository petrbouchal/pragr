...
, using documentation for the following operations (endpoints): [Image Tile endpoint](https://developers.arcgis.com/rest/services-reference/image-tile.htm)
...
The approach draws heavily on code provided by @[yutannihilation](https://github.com/yutannihilation) in her islog post](https://yutani.rbind.io/post/2018-06-09-plot-osm-tiles/) on using OpenStreetMap tiles in 📦 `ggplot2`.
