...
It also provides a set of utilities and shortcuts for making handling data about Prague easier.
...
Additionally, it provides quick access to a number of codes that identify Prague in various administrative or statistical registers.
